  ...
  return (
    <nav 
      className={`border-b border-[rgb(var(--foreground))]/20 bg-[rgb(var(--foreground))]/95 backdrop-blur-md z-50 transition-all duration-300 ease-in-out ${
        isHomePage ? 'absolute w-full' : 'sticky top-0 shadow-sm'
      } ${
        isHomePage && isVisible ? 'translate-y-0 opacity-100' : ''
      } ${
        isHomePage && !isVisible ? '-translate-y-full opacity-0' : ''
      } ${
            ...
            <div className="flex flex-1 max-w-xl mx-4">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-2.5 bg-white/15 backdrop-blur-md border border-white/30 rounded-lg text-white placeholder:text-white/70 focus:outline-none focus:bg-white/25 focus:border-white/50 transition-all"
                />
              </div>
            </div>
          )}
